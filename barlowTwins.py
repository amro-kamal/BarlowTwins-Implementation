...
class BarlowTwins(nn.Module):
    ...
    '''
    def __init__(self, args , projection_dims=[2048,2048,2048] ):
        super().__init__()
        self.projection_dims=projection_dims
        self.args=args
        self.resnet_backbone = torchvision.models.resnet50(pretrained=False)
    ...
    def forward(self, x1, x2):
        ...
        cross_correlation.div_(self.args.batch_size)
